  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        b: common_vendor.sr(guessRef, "58613765-0", {
          "k": "guessRef"
        }),
        c: common_vendor.o(
          //@ts-ignore
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "E:/work-demo/demo1/pagesOrder/payment/payment.vue"]]);
