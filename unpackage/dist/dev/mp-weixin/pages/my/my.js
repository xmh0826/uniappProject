  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        c: common_vendor.t(common_vendor.unref(memberStore).profile.nickname || common_vendor.unref(memberStore).profile.accout)
      } : {}, {
        ...
        f: common_vendor.sr(guessRef, "4a1e7c27-0", {
          "k": "guessRef"
        }),
        g: common_vendor.o(
          //@ts-ignore
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "E:/work-demo/demo1/pages/my/my.vue"]]);
