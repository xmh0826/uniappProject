<script setup lang="ts">
	...
	import { InputNumberBoxEvent } from '../../../types/vk-dada-input-number-box';
						...
						<view class="goods">
							...
							<view class="count">
								<vk-data-input-number-box v-model="item.count" :min="1" :max="item.stock"
									@change="onChangeCount" :index="item.skuId"></vk-data-input-number-box>
							</view>
						</view>
						<!-- 右侧删除按钮 -->
						<template #right>
